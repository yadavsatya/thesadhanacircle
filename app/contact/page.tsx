        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 mb-24">
          ...
          <div className="lg:col-span-1 flex flex-col gap-8">
            <div className="bg-white p-8 rounded-3xl border border-brand-neutral/30 flex flex-col items-center text-center h-full justify-center">
              ...
              <p className="text-brand-accent/90 font-normal">+91 98765 43210</p>
              <p className="text-brand-accent/40 font-normal text-sm mt-2">Mon-Sat, 10 AM to 7 PM</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-3xl border border-brand-neutral/30 flex flex-col items-center text-center h-full justify-center">
              ...
              <a href="mailto:hello@thesadhanacircle.com" className="text-brand-accent/90 font-normal hover:text-brand-gold transition-colors">hello@thesadhanacircle.com</a>
              <p className="text-brand-accent/40 font-normal text-sm mt-2">We typically reply within 24 hours</p>
            </div>
          </div>
